      ...
      <div className="page-sidebar">
        <div className="sidebar-header">
          <Link to="/">
            <img
              ...
              src={`/SonarQubeChineseDoc${version}/images/SonarQubeIcon.svg`}
        ...
        <div className="sidebar-footer">
          ...
          <a href="https://community.sonarsource.com/" rel="noopener noreferrer" target="_blank">
            <img alt="Community" src={`/SonarQubeChineseDoc${version}/images/community.svg`} /> Community
          </a>
          <a
            className="icon-only"
            ...
            target="_blank">
            <img alt="Twitter" src={`/SonarQubeChineseDoc${version}/images/twitter.svg`} />
          </a>
          <a
            className="icon-only"
            ...
            rel="noopener noreferrer"
            target="_blank">
            <img alt="Product News" src={`/SonarQubeChineseDoc${version}/images/newspaper.svg`} />
